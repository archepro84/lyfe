...
import { ImageEntity } from '@infrastructure/out/persistence/topic/schema/image.schema';
import { Document } from 'mongoose';
import { GeometryEntity } from '@infrastructure/out/persistence/user/schema/geometry.schema';
import { Prop, Schema, SchemaFactory } from '@nestjs/mongoose';
import {
  VoteEntity,
  VoteMongoSchema,
  VoteSchema,
} from '@infrastructure/out/persistence/topic/schema/vote.schema';
import { TopicUserEntity } from '@infrastructure/out/persistence/topic/schema/topic-user.schema';
